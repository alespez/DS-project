...
void OperationMessage::copy(const OperationMessage& other)
{
    for (size_t i = 0; i < 100; i++) {
        this->operationToDo[i] = other.operationToDo[i];
    }
    for (size_t i = 0; i < 100; i++) {
        this->partitionToRead[i] = other.partitionToRead[i];
    }
...
void OperationMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimArrayPacking(b,this->operationToDo,100);
    doParsimArrayPacking(b,this->partitionToRead,100);
...
void OperationMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimArrayUnpacking(b,this->operationToDo,100);
    doParsimArrayUnpacking(b,this->partitionToRead,100);
    doParsimUnpacking(b,this->nodeToSend);
}

size_t OperationMessage::getOperationToDoArraySize() const
{
    return 100;
}

char OperationMessage::getOperationToDo(size_t k) const
{
    if (k >= 100) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)100, (unsigned long)k);
    return this->operationToDo[k];
}

void OperationMessage::setOperationToDo(size_t k, char operationToDo)
{
    if (k >= 100) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)100, (unsigned long)k);
    this->operationToDo[k] = operationToDo;
}

size_t OperationMessage::getPartitionToReadArraySize() const
{
    return 100;
}

char OperationMessage::getPartitionToRead(size_t k) const
{
    if (k >= 100) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)100, (unsigned long)k);
    return this->partitionToRead[k];
}

void OperationMessage::setPartitionToRead(size_t k, char partitionToRead)
{
    if (k >= 100) throw omnetpp::cRuntimeError("Array of size %lu indexed by %lu", (unsigned long)100, (unsigned long)k);
    this->partitionToRead[k] = partitionToRead;
}
...
unsigned int OperationMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISARRAY | FD_ISEDITABLE,    // FIELD_operationToDo
        FD_ISARRAY | FD_ISEDITABLE,    // FIELD_partitionToRead
...
const char *OperationMessageDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "char",    // FIELD_operationToDo
        "char",    // FIELD_partitionToRead
...
int OperationMessageDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    ...
    switch (field) {
        case FIELD_operationToDo: return 100;
        case FIELD_partitionToRead: return 100;
        default: return 0;
    }
}
...
std::string OperationMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    OperationMessage *pp = omnetpp::fromAnyPtr<OperationMessage>(object); (void)pp;
    switch (field) {
        case FIELD_operationToDo: return long2string(pp->getOperationToDo(i));
        case FIELD_partitionToRead: return long2string(pp->getPartitionToRead(i));
...
void OperationMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    OperationMessage *pp = omnetpp::fromAnyPtr<OperationMessage>(object); (void)pp;
    switch (field) {
        case FIELD_operationToDo: pp->setOperationToDo(i,string2long(value)); break;
        case FIELD_partitionToRead: pp->setPartitionToRead(i,string2long(value)); break;
...
omnetpp::cValue OperationMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    OperationMessage *pp = omnetpp::fromAnyPtr<OperationMessage>(object); (void)pp;
    switch (field) {
        case FIELD_operationToDo: return pp->getOperationToDo(i);
        case FIELD_partitionToRead: return pp->getPartitionToRead(i);
...
void OperationMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    OperationMessage *pp = omnetpp::fromAnyPtr<OperationMessage>(object); (void)pp;
    switch (field) {
        case FIELD_operationToDo: pp->setOperationToDo(i,omnetpp::checked_int_cast<char>(value.intValue())); break;
        case FIELD_partitionToRead: pp->setPartitionToRead(i,omnetpp::checked_int_cast<char>(value.intValue())); break;
